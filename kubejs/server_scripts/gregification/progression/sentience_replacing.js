...
.itemInputs('gtceu:wetware_printed_circuit_board', '2x gtceu:wetware_processor_assembly', 'gtceu:sentient_smd_diode', '2x gtceu:b_nor_memory_chip', '4x gtceu:b_ram_chip', '24x gtceu:fine_chronocrytic-vhaelsalite_wire', '32x gtceu:polyether_ether_ketone_foil', '4x gtceu:astrazine-e_plate')
...
.itemInputs('gtceu:wetware_printed_circuit_board', '2x gtceu:wetware_processor', '2x gtceu:sentient_smd_inductor', '3x gtceu:sentient_smd_capacitor', '3x gtceu:b_ram_chip', '16x gtceu:fine_chronocrytic-vhaelsalite_wire')
...
.itemInputs('gtceu:neuro_processing_unit', 'gtceu:biological_soc', '4x gtceu:fine_chronocrytic-vhaelsalite_wire', '4x gtceu:naquadrium_bolt')
