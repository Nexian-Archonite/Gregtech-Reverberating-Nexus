...
GTM.particle_accelerator('gamma_photon_production')
    .perTick(true)
    .inputFluids('gtceu:hydrogen 10')
    .outputFluids('gtceu:gamma_photon_plasma 10')
...
GTM.particle_accelerator('positron_pair_production')
    .perTick(true)
    .inputFluids('gtceu:gamma_photon_plasma 10')
    .outputFluids('gtceu:electron 5', 'gtceu:positron 5')
    .perTick(false)
    .fusionStartEU(2097152)
    .EUt(32768)
    .duration(1000)
...
.perTick(true)
.inputFluids('gtceu:neutron 10')
.outputFluids('gtceu:neutron 5', 'gtceu:nulltron 5')
.perTick(false)
...
.perTick(true)
.inputFluids('gtceu:proton 10')
.outputFluids('gtceu:proton 5', 'gtceu:negatron 5')
.perTick(false)
...
GTM.particle_accelerator('charm_top_pair_production')
.perTick(true)
.inputFluids('gtceu:proton 50', 'gtceu:negatron 50')
.outputFluids('gtceu:charm_quark 20', 'gtceu:curse_quark 20', 'gtceu:top_quark 1', 'gtceu:inferior_quark 1')
.perTick(false)
.fusionStartEU(8388608)
.EUt(524288)
.duration(1000)
