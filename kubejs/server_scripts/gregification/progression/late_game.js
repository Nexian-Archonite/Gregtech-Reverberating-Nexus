...
GTM.assembly_line('transcendental_polydimensional_accelerator')
.itemInputs('gtceu:luv_fusion_reactor', '32x #gtceu:circuits/zpm', '64x gtceu:auralloy-omega_over_transcendentine_plate', '64x gtceu:auralloy-omega_over_transcendentine_plate', '8x gtceu:superconducting_coil', '32x gtceu:cryosporsite_rod')
...
.stationResearch(global.AssemblyLineResearch(event, 'transcendental_polydimensional_accelerator', 'gtceu:auralloy-omega_over_transcendentine_casing', 48, 102400, va.luv))
.duration(4000)
.EUt(131072)
...
GTM.fusion_accelerator('aurorialis')
.perTick(true)
.inputFluids('gtceu:source 128', 'gtceu:fermium 16')
.outputFluids('gtceu:aurorialis 36')
.duration(400)
.EUt(va.uhv, 4)

GTM.fusion_accelerator('aurorialis_anti')
.perTick(true)
.inputFluids('gtceu:antisource 128', 'gtceu:antifermium 16')
.outputFluids('gtceu:aurorialis 36')
.duration(400)
.EUt(va.uhv, 4)

GTM.fusion_accelerator('aurorialis_alt')
.perTick(true)
.inputFluids('gtceu:antisource 128', 'gtceu:fermium 16')
.outputFluids('gtceu:aurorialis 36')
.duration(400)
.EUt(va.uhv, 4)

GTM.fusion_accelerator('aurorialis_alt_alt')
.perTick(true)
.inputFluids('gtceu:source 128', 'gtceu:antifermium 16')
.outputFluids('gtceu:aurorialis 36')
.duration(400)
.EUt(va.uhv, 4)
...
GTM.assembly_line('mythrovirdyne_transcendence_accelerator')
.itemInputs('gtceu:uv_fusion_reactor', '32x #gtceu:circuits/uhv', '64x gtceu:mythrovirdyne_plate', '64x gtceu:mythrovirdyne_plate', '8x gtceu:transcendent_dilithide_coil_block', '32x gtceu:bose-einstein_neutronium_rod')
.inputFluids('gtceu:polyether_ether_ketone 32000', 'gtceu:awakened_draconium 24000')
.stationResearch(global.AssemblyLineResearch(event, 'mythrovirdyne_transcendence_accelerator', 'gtceu:transcendental_polydimensional_accelerator', 96, 307200, va.zpm))
.duration(1000)
.EUt(524288)

GTM.assembly_line('everflamed_hell_forge')
.itemInputs('gtceu:mega_blast_furnace', '6x #gtceu:circuits/uhv', '16x gtceu:double_activated_nexian_pyrite_plate', '2x gtceu:uhv_electric_pump', '6x gtceu:uhv_robot_arm', '4x gtceu:uhv_field_generator', '4x gtceu:abyssal_netherite_spring')
.itemOutputs('gtceu:everflamed_hell_forge')
.stationResearch(global.AssemblyLineResearch(event, 'everflamed_hell_forge', 'gtceu:mega_blast_furnace', 96, 307200, va.zpm))
.duration(1000)
.EUt(2097152)
...
GTM.assembly_line('bacteria_synthesizer')
.itemInputs('gtceu:polyether_ether_ketone_frame', '16x gtceu:polyether_ether_ketone_plate', '4x gtceu:uhv_microfluidic_flow_valve', '#gtceu:circuits/uhv', 'gtceu:cleanroom')
.inputFluids('gtceu:indium-vor-dys-cad_supersolder_alloy 1152', 'gtceu:pedot_pss 2304')
.itemOutputs('gtceu:bacteria_synthesizer')
.duration(1000)
.EUt(524288)

GTM.assembly_line('bacterial_hydrocarbon_harvester')
.itemInputs('gtceu:aurorialis_frame', '16x gtceu:polyether_ether_ketone_plate', '4x gtceu:uhv_catalyst_core', '2x #gtceu:circuits/uhv', 'gtceu:cleanroom', '4x gtceu:aurorialis_plate')
.inputFluids('gtceu:indium-vor-dys-cad_supersolder_alloy 1152', 'gtceu:pedot_pss 2304')
.itemOutputs('gtceu:bacterial_hydrocarbon_harvester')
.duration(1000)
.EUt(524288)
...
.inputFluids('gtceu:thiophene 1000', 'gtceu:bromine 6000')
.outputFluids('gtceu:tetrabromothiophene 1000', 'gtceu:hydrogen_bromide 2000')
.duration(200)
.EUt(512)
.addData('HeatPressure', 1.5)
.addData('Temp', 323)
...
GTM.manifold_collapsing('dark_hadron_collapsing')
.perTick(true)
.inputFluids('gtceu:dark_hadron 2')
.chancedFluidOutputLogic('xor')
.chancedFluidOutput('gtceu:exo_quark 2', 2800, 0)
.chancedFluidOutput('gtceu:meso_quark 2', 2800, 0)
.chancedFluidOutput('gtceu:endo_quark 2', 2800, 0)
.chancedFluidOutput('gtceu:exotron 2', 1600, 0)
.duration(20)
.EUt(va.uhv, 8)

Object.entries({
    matter: 'omni_hadron',
    antimatter: 'null_hadron'
}).forEach(([side, hadron]) => {
    GTM.equalizer(`neutral_${side}_nexon_perfection`)
    .itemInputs(`gtceu:neutral_${side}_nexon`)
    .itemOutputs(`gtceu:perfected_${side}_nexon`)
    .perTick(true)
    .inputFluids(`gtceu:${hadron} 1`)
    .duration(20)
    .EUt(va.uhv, 8)
})

;Object.entries({
    matter: { catalyst: 'fermium', output: 'nullic_omnate', opposput: 'omnic_nullate' },
    antimatter: { catalyst: 'antifermium', output: 'omnic_nullate', opposput: 'nullic_omnate' }
}).forEach(function(entry) {
    var side = entry[0]
    var catalyst = entry[1].catalyst
    var output = entry[1].output
    var opposput = entry[1].opposput
    
    GTM.equalizer(side + '_nexon_stabilization')
    .itemInputs('3x gtceu:perfected_' + side + '_nexon', '3x gtceu:' + catalyst + '_gem')
    .itemOutputs('2x gtceu:' + output + '_gem', 'gtceu:' + opposput + '_gem')
    .duration(20)
    .EUt(va.uhv, 8)

})

    GTM.equalizer('matter-antimatter_gem_separation')
    .itemInputs('gtceu:nullic_omnate_gem', 'gtceu:omnic_nullate_gem')
    .perTick(true)
    .inputFluids('gtceu:antitau 5', 'gtceu:tau 5')
    .perTick(false)
    .itemOutputs('3x gtceu:stabilized_matter-fermite', '3x gtceu:stabilized_antimatter-fermite')
    .duration(200)
    .EUt(va.uhv, 8)
