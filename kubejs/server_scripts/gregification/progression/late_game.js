...
GTM.chemical_reactor('ruthenium_phosphate_reduction')
...
GTM.chemical_reactor('rhodium_chloride_processing')
    ...
    .outputFluids('gtceu:rhodium_sulfate 1000', 'gtceu:hydrochloric_acid 3000')
    .EUt(7680)
    .duration(200)

GTM.electrolyzer('rhodium_sulfate_electrolysis')
    .inputFluids('gtceu:rhodium_sulfate 1000')
    .itemOutputs('2x gtceu:rhodium_dust')
    .outputFluids('gtceu:sulfuric_acid 1000', 'gtceu:oxygen 3000')
    .EUt(7680)
    .duration(400)

GTM.chemical_reactor('osmium_chloride_oxidation')
    .itemInputs('1x gtceu:osmium_chloride_dust')
    .inputFluids('gtceu:oxygen 4000')
    .itemOutputs('1x gtceu:osmium_tetroxide_dust')
