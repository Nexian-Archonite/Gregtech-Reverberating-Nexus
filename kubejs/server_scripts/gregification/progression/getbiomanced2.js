...
Object.entries(animalspawnegglistforthereasonsaboveme).forEach(([victim, data]) => {
    ...
    const recipe2 = GTM.organism_incubation_chamber(`${victim}_spawn_egg_incubation`) // new and improved! now with 30% more recipes per recipe
