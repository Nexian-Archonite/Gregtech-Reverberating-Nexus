...
event.recipes.create.sequenced_assembly(
    ...
    [
        ...
        CRT.deploying(EIC, [EIC, 'gtceu:wizarding_steel_rod']),
...
const RCCB = 'gtceu:resin_printed_circuit_board'
...
const beltconnectorrubberparts = {
    "rubber": 2,
    "silicone_rubber": 4,
    "polyethylene": 6,
...
.inputFluids('water 16')
.itemOutputs('6x create:shaft')
.EUt(32)
.duration(400)

GTM.cutter(('alloy_to_shaft_distilled_water'))
.itemInputs('gtceu:andesite_alloy_ingot')
...
const ahshitherewegoagain = {
    ...
    'steel_plate': 4,
    'tungsten_steel_plate': 64
}
Object.entries(ahshitherewegoagain).forEach(([input, count]) => {
event.shaped(`${count}x create:cogwheel`, [
'SP',
'F '
], {
S: 'create:shaft',
...
event.shaped(`${count}x create:large_cogwheel`, [
'SP',
'PF'
], {
S: 'create:shaft',
...
CRT.deploying(`${count}x create:cogwheel`, ['create:shaft', `gtceu:${input}`])
CRT.deploying(`create:large_cogwheel`, ['create:cogwheel', `gtceu:${input}`])
})
