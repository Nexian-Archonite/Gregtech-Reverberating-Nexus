...
recipeTypes.forEach(recipeTypes => {
    event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_rod`},
    `gtceu:${inputs}_rod`,
    `gtceu:${replacement}_rod`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_round`},
    `gtceu:${inputs}_round`,
    `gtceu:${replacement}_round`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes,  input: `gtceu:${inputs}_plate`},
    `gtceu:${inputs}_plate`,
    `gtceu:${replacement}_plate`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:long_${inputs}_rod`},
    `gtceu:long_${inputs}_rod`,
    `gtceu:long_${replacement}_rod`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:small_${inputs}_gear`},
    `gtceu:small_${inputs}_gear`,
    `gtceu:small_${replacement}_gear`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_gear`},
    `gtceu:${inputs}_gear`,
    `gtceu:${replacement}_gear`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_rotor`},
    `gtceu:${inputs}_rotor`,
    `gtceu:${replacement}_rotor`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_frame`},
    `gtceu:${inputs}_frame`,
    `gtceu:${replacement}_frame`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_tiny_fluid_pipe`},
    `gtceu:${inputs}_tiny_fluid_pipe`,
    `gtceu:${replacement}_tiny_fluid_pipe`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_small_fluid_pipe`},
    `gtceu:${inputs}_small_fluid_pipe`,
    `gtceu:${replacement}_small_fluid_pipe`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_normal_fluid_pipe`},
    `gtceu:${inputs}_normal_fluid_pipe`,
    `gtceu:${replacement}_normal_fluid_pipe`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_large_fluid_pipe`},
    `gtceu:${inputs}_large_fluid_pipe`,
    `gtceu:${replacement}_large_fluid_pipe`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_huge_fluid_pipe`},
    `gtceu:${inputs}_huge_fluid_pipe`,
    `gtceu:${replacement}_huge_fluid_pipe`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:fine_${inputs}_wire`},
    `gtceu:fine_${inputs}_wire`,
    `gtceu:fine_${replacement}_wire`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_single_wire`},
    `gtceu:${inputs}_single_wire`,
    `gtceu:${replacement}_single_wire`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_double_wire`},
    `gtceu:${inputs}_double_wire`,
    `gtceu:${replacement}_double_wire`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_quadruple_wire`},
    `gtceu:${inputs}_quadruple_wire`,
    `gtceu:${replacement}_quadruple_wire`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_octal_wire`},
    `gtceu:${inputs}_octal_wire`,
    `gtceu:${replacement}_octal_wire`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_hex_wire`},
    `gtceu:${inputs}_hex_wire`,
    `gtceu:${replacement}_hex_wire`
)
...
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_ring`},
    `gtceu:${inputs}_ring`,
    `gtceu:${replacement}_ring`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_bolt`},
    `gtceu:${inputs}_bolt`,
    `gtceu:${replacement}_bolt`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_screw`},
    `gtceu:${inputs}_screw`,
    `gtceu:${replacement}_screw`
)
event.replaceInput(
    {not: {id: RegexList}, mod: "gtceu", type: recipeTypes, input: `gtceu:${inputs}_foil`},
    `gtceu:${inputs}_foil`,
    `gtceu:${replacement}_foil`
)

})

}) */ // old version and shit
