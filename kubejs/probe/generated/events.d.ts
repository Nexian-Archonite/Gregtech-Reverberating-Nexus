...
declare const MolDrawEvents: {
    /**
     * @at *client*
    */
alloys(handler: (event: Internal.MolDrawAlloysJS) => void):void,
    /**
     * @at *client*
    */
molecules(handler: (event: Internal.MolDrawMoleculesJS) => void):void,
};
...
oreVeins(handler: (event: Internal.GTOreVeinEventJS) => void):void,
     ...
     * @at *server*
    */
registerCapes(handler: (event: Internal.RegisterCapesEventJS) => void):void,
    /**
     * @at *server*
    */
...
declare const FTBChunksEvents: {
    /**
     * @at *server*
     * 
     * @cancellable
    */
before(extra: string, handler: (event: Internal.BeforeEventJS) => void):void,
    /**
     * @at *server*
    */
after(extra: string, handler: (event: Internal.AfterEventJS) => void):void,
};
...
materialModification(handler: (event: Internal.MaterialModificationEventJS) => void):void,
     ...
     * @at *startup*
    */
craftingComponents(handler: (event: Internal.CraftingComponentsEventJS) => void):void,
};
...
registry(type: "brandonscore:hud_elements", handler: (event: Registry.HudElements) => void):void,
registry(type: "brandonscore:world_entity", handler: (event: Registry.WorldEntity) => void):void,
registry(type: "compactcrafting:catalyst_types", handler: (event: Registry.CatalystTypes) => void):void,
registry(type: "compactcrafting:recipe_components", handler: (event: Registry.RecipeComponents) => void):void,
registry(type: "compactcrafting:recipe_layers", handler: (event: Registry.RecipeLayers) => void):void,
registry(type: "compactmachines:graph_edges", handler: (event: Registry.GraphEdges) => void):void,
registry(type: "compactmachines:graph_nodes", handler: (event: Registry.GraphNodes) => void):void,
registry(type: "compactmachines:room_upgrades", handler: (event: Registry.RoomUpgrades) => void):void,
registry(type: "compactmachines:tunnel_types", handler: (event: Registry.TunnelTypes) => void):void,
registry(type: "create_factory_abstractions:generic_keys", handler: (event: Registry.GenericKeys) => void):void,
registry(type: "draconicevolution:modules", handler: (event: Registry.Modules) => void):void,
registry(type: "extra_gauges:panel_connections", handler: (event: Registry.PanelConnections) => void):void,
registry(type: "extra_gauges:panels", handler: (event: Registry.Panels) => void):void,
