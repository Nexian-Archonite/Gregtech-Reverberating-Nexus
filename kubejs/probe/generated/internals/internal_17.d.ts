...
declare namespace Internal {
    ...
    */
    ...
    class ServerPlayerGameMode implements Internal.ServerPlayerGameModeAccessor {
        ...
        handler$hcc000$startBlockBreak(pos: BlockPos_, playerAction: Internal.ServerboundPlayerActionPacket$Action_, direction: Internal.Direction_, worldHeight: number, i: number, info: Internal.CallbackInfo_): void;
    ...
    class ScrapBrickSlabBlock extends Internal.SlabBlock {
        constructor()
        /**
         * @deprecated
        */
    ...
    type ScrapBrickSlabBlock_ = ScrapBrickSlabBlock;
    ...
    class SimpleContainer implements net.minecraft.world.Container, Internal.StackedContentsCompatible, Internal.SpecialLogicInventory {
        ...
        hashCode(): number;
        redirect$epn000$fabric_redirectMarkDirty(self: Internal.SimpleContainer_): void;
        isMutable(): boolean;
        clear(): void;
        wait(arg0: number): void;
