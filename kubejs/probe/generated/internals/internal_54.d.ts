...
declare namespace Internal {
    ...
    class ArcanePlatform extends Internal.ArcanePedestal {
        constructor()
        /**
         * @deprecated
        */
        ...
        */
        ...
        get mod(): string
        set hasCollision(arg0: boolean)
        static readonly DOWN: (Internal.ArrayVoxelShape) & (Internal.VoxelShape);
        static readonly EAST: (Internal.ArrayVoxelShape) & (Internal.VoxelShape);
        static readonly WEST: (Internal.ArrayVoxelShape) & (Internal.VoxelShape);
        static readonly NORTH: (Internal.ArrayVoxelShape) & (Internal.VoxelShape);
        static readonly UP: (Internal.ArrayVoxelShape) & (Internal.VoxelShape);
        static readonly SOUTH: (Internal.ArrayVoxelShape) & (Internal.VoxelShape);
    }
    type ArcanePlatform_ = ArcanePlatform;
