...
declare namespace Internal {
    ...
    class PalettedContainer <T> implements Internal.PaletteResize<T>, Internal.ExtendedPalettedContainer<any>, Internal.ReadableContainerExtended<any>, Internal.PalettedContainerRO<T> {
        ...
        hashCode(): number;
        handler$cao000$count(consumer: Internal.PalettedContainer$CountConsumer_<any>, ci: Internal.CallbackInfo_): void;
        copy(): this;
        ...
        wait(arg0: number): void;
        acquire(): void;
        handler$cal000$removeLockHelper(ci: Internal.CallbackInfo_): void;
