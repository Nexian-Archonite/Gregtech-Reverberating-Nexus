...
declare namespace Internal {
    ...
    class BakedGlyph {
        ...
        getClass(): typeof any;
        handler$blb000$render(italic: boolean, x: number, y: number, matrix: Matrix4f_, vertexConsumer: Internal.VertexConsumer_, red: number, green: number, blue: number, alpha: number, light: number, ci: Internal.CallbackInfo_): void;
    ...
    */
    ...
    class SpiderAspectEffect extends Internal.MagicMobEffect {
        ...
        static increaseDamage(arg0: Internal.LivingDamageEvent_): void;
    ...
    interface IControllableStorage extends Internal.IControllerBoundable {
        getControlledStorageBlockPos(): BlockPos;
        ...
        get controlledStorageBlockPos(): BlockPos
