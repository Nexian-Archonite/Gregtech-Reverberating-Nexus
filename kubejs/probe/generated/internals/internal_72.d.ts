...
declare namespace Internal {
    ...
    class ChiseledBookShelfBlockEntity extends Internal.BlockEntity implements net.minecraft.world.Container, Internal.SpecialLogicInventory {
        ...
        */
        ...
        handler$fae000$setStackBypass(slot: number, stack: Internal.ItemStack_, ci: Internal.CallbackInfo_): void;
    ...
    class IntProviderIngredient extends Internal.Ingredient implements Internal.IRangedIngredient {
        ...
        static create_$md$8ab22f$2(arg0: Internal.Stream_<any>): Internal.Ingredient;
        ...
        isWildcard(): boolean;
        handler$cnl000$blah(arg0: Internal.CallbackInfoReturnable_<any>): void;
...
declare namespace alexthw.ars_elemental.util {
    class ItemInventory extends Internal.SimpleContainer {
        ...
        getHeight(): number;
        redirect$fai000$fabric_redirectMarkDirty(self: Internal.SimpleContainer_): void;
        countNonEmpty(): number;
        asContainer(): net.minecraft.world.Container;
        toString(): string;
