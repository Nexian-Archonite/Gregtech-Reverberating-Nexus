...
declare namespace Internal {
    ...
    class PalettedContainer <T> implements Internal.PaletteResize<T>, Internal.ExtendedPalettedContainer<any>, Internal.ReadableContainerExtended<any>, Internal.PalettedContainerRO<T> {
        ...
        notify(): void;
        handler$cah000$removeLockHelper(ci: Internal.CallbackInfo_): void;
        wait(arg0: number, arg1: number): void;
        ...
        handler$cak000$count(consumer: Internal.PalettedContainer$CountConsumer_<any>, ci: Internal.CallbackInfo_): void;
        toString(): string;
    ...
    class SchematicannonBlockEntity extends Internal.SmartBlockEntity implements Internal.MenuProvider {
        ...
        */
        ...
        getAttachedOrGet<A>(type: Internal.AttachmentType_<A>, defaultValue: Internal.Supplier_<A>): A;
        lazyTick(): void;
        handler$gpf000$modifyCooldownEveryTick(arg0: Internal.CallbackInfo_): void;
