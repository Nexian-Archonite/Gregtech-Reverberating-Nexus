...
declare namespace Internal {
    ...
    abstract class GeoRenderEvent$Item extends net.minecraftforge.eventbus.api.Event implements Internal.GeoRenderEvent {
        constructor()
        constructor(arg0: Internal.GeoItemRenderer_<any>)
        getResult(): Internal.Event$Result;
        setCanceled(arg0: boolean): void;
        getClass(): typeof any;
        toString(): string;
        getRenderer(): Internal.GeoItemRenderer<any>;
        setPhase(arg0: Internal.EventPriority_): void;
        notifyAll(): void;
        isCanceled(): boolean;
        notify(): void;
        ...
        set canceled(arg0: boolean)
        get class(): typeof any
        get renderer(): Internal.GeoItemRenderer<any>
        set phase(arg0: Internal.EventPriority_)
        get canceled(): boolean
        set result(arg0: Internal.Event$Result_)
        get cancelable(): boolean
    ...
    class ClientboundSetEntityMotionPacket implements Internal.Packet<Internal.ClientGamePacketListener> {
        ...
        handler$cfn000$init(arg0: number, arg1: Vec3d_, arg2: Internal.CallbackInfo_): void;
    ...
    class LootParams$Builder {
        ...
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        handler$ebk000$addTypeOnCreate(paramSet: Internal.LootContextParamSet_, cir: Internal.CallbackInfoReturnable_<any>): void;
