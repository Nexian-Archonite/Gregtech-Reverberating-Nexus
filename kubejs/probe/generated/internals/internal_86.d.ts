...
declare namespace Internal {
    ...
    class SurgicalPrecisionEnchantment extends Internal.Enchantment {
    ...
    type SurgicalPrecisionEnchantment_ = SurgicalPrecisionEnchantment;
    ...
    */
    ...
    class AdvCraftingCPULogic {
        constructor(arg0: Internal.AdvCraftingCPU_)
    ...
    type AdvCraftingCPULogic_ = AdvCraftingCPULogic;
    ...
    abstract class AbstractSmokeStackBlock <T extends Internal.SmartBlockEntity> extends Internal.Block implements Internal.ProperWaterloggedBlock, Internal.IWrenchable, Internal.IBE<T> {
        constructor(properties: Internal.BlockBehaviour$Properties_, shape: any_, variant: string)
        /**
         * @deprecated
        */
        getSignal(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_, arg3: Internal.Direction_): number;
        ...
        */
        ...
        static readonly WATERLOGGED: (Internal.BooleanProperty) & (Internal.BooleanProperty);
        static readonly STYLE: Internal.EnumProperty<Internal.SmokestackStyle>;
        static readonly POWERED: (Internal.BooleanProperty) & (Internal.BooleanProperty);
    }
    type AbstractSmokeStackBlock_<T extends Internal.SmartBlockEntity> = AbstractSmokeStackBlock<T>;
    ...
    class VerticalSlabBlock extends Internal.Block implements Internal.IZetaBlockExtensions, Internal.FuelHandler$ICustomWoodFuelValue, Internal.SimpleWaterloggedBlock, Internal.IForgeBlock, Internal.IZetaBlockColorProvider {
        ...
        */
        ...
        static readonly WATERLOGGED: (Internal.BooleanProperty) & (Internal.BooleanProperty);
        static readonly TYPE: Internal.EnumProperty<Internal.VerticalSlabBlock$VerticalSlabType>;
    }
    ...
    class ChunkMap$TrackedEntity implements Internal.ChunkMapAccessor$TrackedEntityAccessor, Internal.EntityTrackerAccessor {
        ...
        hashCode(): number;
        wait(): void;
        localvar$egi000$modifyFlag(arg0: boolean): boolean;
        localvar$djn000$railways$securitycraft$modifyFlag(original: boolean): boolean;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
    ...
    interface AutoCraftingContainer {
        isVisibleInTerminal(): boolean;
        abstract getPatternConfigInputs(arg0: number): Internal.LinkedHashMap<Internal.AEKey, number>;
        abstract getEnabledPatternSlots(): Internal.List<boolean>;
        abstract getGrid(): Internal.IGrid;
        abstract getLocator(): Internal.MenuLocator;
        abstract setStockAmount(arg0: number, arg1: number, arg2: number): void;
        abstract getTerminalPatternInventory(): Internal.InternalInventory;
        getTerminalSortOrder(): number;
        abstract toggleEnablePattern(arg0: number): void;
        abstract setMaxCrafted(arg0: number, arg1: number): void;
        abstract getInvalidPatternSlots(): Internal.List<boolean>;
        abstract getPatternConfigOutput(arg0: number): com.mojang.datafixers.util.Pair<Internal.AEKey, number>;
    ...
    type AutoCraftingContainer_ = AutoCraftingContainer;
    interface Constable {
    ...
    class RollerBlock extends Internal.AttachedActorBlock implements Internal.IBE<Internal.RollerBlockEntity> {
        ...
        */
        ...
        getId(): string;
        getLootTable(): ResourceLocation;
        onBlockEntityUse(arg0: Internal.BlockGetter_, arg1: BlockPos_, arg2: Internal.Function_<Internal.RollerBlockEntity, Internal.InteractionResult>): Internal.InteractionResult;
        /**
         * @deprecated
        */
        getInteractionShape(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_): Internal.VoxelShape;
    ...
    class FuelLoaderBlock extends earth.terrarium.adastra.common.blocks.base.MachineBlock {
        constructor(arg0: Internal.BlockBehaviour$Properties_)
        /**
         * @deprecated
        */
    ...
    type FuelLoaderBlock_ = FuelLoaderBlock;
    ...
    class WixieCauldron extends Internal.SummonBlock {
        constructor()
        /**
         * @deprecated
        */
        ...
        */
        ...
        get mod(): string
        set hasCollision(arg0: boolean)
        static readonly FILLED: (Internal.BooleanProperty) & (Internal.BooleanProperty);
    }
    type WixieCauldron_ = WixieCauldron;
    ...
    class SettingsFrom extends Internal.Enum<Internal.SettingsFrom> {
        ...
        notify(): void;
        wait(arg0: number, arg1: number): void;
        "compareTo(appeng.util.SettingsFrom)"(arg0: Internal.SettingsFrom_): number;
        compareTo(arg0: any): number;
        name(): string;
        hashCode(): number;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.SettingsFrom>>;
        getDeclaringClass(): typeof Internal.SettingsFrom;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        compareTo(arg0: Internal.SettingsFrom_): number;
        "compareTo(java.lang.Object)"(arg0: any): number;
        static values(): Internal.SettingsFrom[];
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.SettingsFrom
        static readonly DISMANTLE_ITEM: (Internal.SettingsFrom) & (Internal.SettingsFrom);
        static readonly MEMORY_CARD: (Internal.SettingsFrom) & (Internal.SettingsFrom);
    }
    ...
    class PackagerBlockEntity extends Internal.SmartBlockEntity implements Internal.GenericPackagerBlockEntity {
        constructor(arg0: Internal.BlockEntityType_<any>, arg1: BlockPos_, arg2: Internal.BlockState_)
        requestModelDataUpdate(): void;
        getRenderedBox(): Internal.ItemStack;
        destroy(): void;
        sodiumdynamiclights$updateDynamicLight(renderer: Internal.LevelRenderer_): boolean;
        unwrapBox(box: Internal.ItemStack_, simulate: boolean): boolean;
        "areCapsCompatible(net.minecraftforge.common.capabilities.CapabilityDispatcher)"(arg0: Internal.CapabilityDispatcher_): boolean;
        readClient(arg0: Internal.CompoundTag_): void;
        isVirtual(): boolean;
        static from(packagerBlockEntity: Internal.PackagerBlockEntity_): Internal.GenericPackagerBlockEntity;
        /**
         * @deprecated
        */
        setBlockState(arg0: Internal.BlockState_): void;
        ...
        getCapability<T>(arg0: Internal.Capability_<T>): Internal.LazyOptional<T>;
        writeSafe(arg0: Internal.CompoundTag_): void;
        getAvailableItems(scanInputSlots: boolean): Internal.InventorySummary;
        getType(): Internal.BlockEntityType<any>;
        static transfer(original: Internal.AttachmentTarget_, target: Internal.AttachmentTarget_, isDeath: boolean): void;
        writeClient(arg0: Internal.CompoundTag_): Internal.CompoundTag;
        "getUpdatePacket()"(): Internal.ClientboundBlockEntityDataPacket;
        ...
        getPersistentData(): Internal.CompoundTag;
        toString(): string;
        createFactoryLogistics$extractBox(queuedRequests: Internal.Collection_<any>): com.mojang.datafixers.util.Pair<any, any>;
        markVirtual(): void;
        triggerEvent(arg0: number, arg1: number): boolean;
        hasLevel(): boolean;
        notifyAll(): void;
        forEachBehaviour(arg0: Internal.Consumer_<Internal.BlockEntityBehaviour>): void;
        sdl$dynamicLightTick(): void;
        createFactoryLogistics$deductFromAccurateSummary(behaviour: Internal.LogisticallyLinkedBehaviour_, content: Internal.PackageBuilder_): void;
        invalidate(): void;
        updateSignAddress(): void;
        callSaveMetadata(arg0: Internal.CompoundTag_): void;
        attemptToSendGeneric(queuedRequests: Internal.Collection_<any>): void;
        getAttachedOrCreate<A>(type: Internal.AttachmentType_<A>, initializer: Internal.Supplier_<A>): A;
        setWorldPosition(arg0: BlockPos_): void;
        wait(arg0: number): void;
        getAttachedOrThrow<A>(type: Internal.AttachmentType_<A>): A;
        ...
        getRenderData(): any;
        getModelData(): Internal.ModelData;
        attemptToSend(queuedRequests: Internal.List_<any>): void;
        equals(arg0: any): boolean;
    ...
    class RenderedBlockItem extends Internal.BlockItem {
    ...
    type RenderedBlockItem_ = RenderedBlockItem;
    ...
    class LongevityEnchantment extends Internal.Enchantment {
        constructor(arg0: Internal.Enchantment$Rarity_, arg1: Internal.EnchantmentCategory_, ...arg2: Internal.EquipmentSlot_[])
        getClass(): typeof any;
        getDamageProtection(arg0: number, arg1: DamageSource_): number;
        getFullname(arg0: number): net.minecraft.network.chat.Component;
    ...
    type LongevityEnchantment_ = LongevityEnchantment;
    ...
    class BlastProperty implements Internal.IMaterialProperty {
        constructor(arg0: number, arg1: Internal.BlastProperty$GasTier_)
        constructor()
        constructor(arg0: number)
        constructor(arg0: number, arg1: Internal.BlastProperty$GasTier_, arg2: number, arg3: number, arg4: number, arg5: number)
        getClass(): typeof any;
        setVacuumEUtOverride(arg0: number): void;
        getVacuumEUtOverride(): number;
        toString(): string;
        setVacuumDurationOverride(arg0: number): void;
        getEUtOverride(): number;
        notifyAll(): void;
        verifyProperty(arg0: Internal.MaterialProperties_): void;
        setDurationOverride(arg0: number): void;
        setEUtOverride(arg0: number): void;
        notify(): void;
        getDurationOverride(): number;
        wait(arg0: number, arg1: number): void;
        getVacuumDurationOverride(): number;
        setGasTier(arg0: Internal.BlastProperty$GasTier_): void;
        hashCode(): number;
        static validateGasTier(arg0: string): Internal.BlastProperty$GasTier;
        wait(): void;
        getGasTier(): Internal.BlastProperty$GasTier;
        getBlastTemperature(): number;
        wait(arg0: number): void;
        setBlastTemperature(arg0: number): void;
        equals(arg0: any): boolean;
        get class(): typeof any
        set vacuumEUtOverride(arg0: number)
        get vacuumEUtOverride(): number
        set vacuumDurationOverride(arg0: number)
        get EUtOverride(): number
        set durationOverride(arg0: number)
        set EUtOverride(arg0: number)
        get durationOverride(): number
        get vacuumDurationOverride(): number
        set gasTier(arg0: Internal.BlastProperty$GasTier_)
        get gasTier(): Internal.BlastProperty$GasTier
        get blastTemperature(): number
        set blastTemperature(arg0: number)
    }
