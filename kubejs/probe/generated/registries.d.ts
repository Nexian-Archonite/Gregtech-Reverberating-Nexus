...
declare namespace Registry {
    ...
    class Block extends Internal.RegistryEventJS<any> {
        ...
        create(id: string, type: "gtceu:active"): Internal.ActiveBlockBuilder;
    ...
    class CatalystTypes extends Internal.RegistryEventJS<any> {
    }
    class RecipeComponents extends Internal.RegistryEventJS<any> {
    }
    class RecipeLayers extends Internal.RegistryEventJS<any> {
    }
    class GraphEdges extends Internal.RegistryEventJS<any> {
    }
    class GraphNodes extends Internal.RegistryEventJS<any> {
    }
    class RoomUpgrades extends Internal.RegistryEventJS<any> {
    }
    class TunnelTypes extends Internal.RegistryEventJS<any> {
    }
    class GenericKeys extends Internal.RegistryEventJS<any> {
    }
    class Modules extends Internal.RegistryEventJS<any> {
    }
    class PanelConnections extends Internal.RegistryEventJS<any> {
    }
    class Panels extends Internal.RegistryEventJS<any> {
    }
