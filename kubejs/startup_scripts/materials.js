...
AlienAlloy('abyssal_netherite', 'ingot', 0x30283A, 0xA020FF, METALLIC, [plates, rod, gear, small_gear, frame, spring, bolt_and_screw, rotor, dense_plate, fine_wire, round, chainlet, chain_mesh], ['13x auralloy-omega', '4x korzene', '4x vaexium', '2x stellarite'], 16000, va.uv, 1100, null, null)
AlienAlloy('nexian_pyrite', 'ingot', 0x8B1515, 0x5580B8, METALLIC, null, ['37x nexus_steel', '12x abyssal_netherite', '8x vhoric_steel', '4x sulvan_steel', '4x pyrghul_alloy', '3x promethium', '2x ignatherm'], 16800, va.uv, 900, null, null)
...
// UEV
AlienAlloy('aelczyr', 'ingot', 0xDDEEFF, 0x3366AA, SHINY, [rod, frame, plates, gear, foil, no_abs_recipe], ['aelvythrex', 'czyvhaeln', 'lutetium', 'holmium'], 17420, va.uev, 900, null, null)
AlienAlloy('thulvaex', 'ingot', 0x334477, 0x111122, SHINY, [rod, frame, plates, gear, foil, no_abs_recipe], ['thurvaexi', 'kholvaetzh', 'steel', 'chromium'], 18240, va.uev, 950, null, null)
AlienAlloy('vrethren', 'ingot', 0x553322, 0xDD4400, METALLIC, [rod, frame, plates, gear, foil, no_abs_recipe], ['vrethdulix', 'ghauzrenit', 'trinium', 'chromium'], 17180, va.uev, 850, null, null)
AlienAlloy('jolvelix', 'ingot', 0x221100, 0xCC4411, SHINY, [rod, frame, plates, gear, foil, no_abs_recipe], ['jolvekrasz', 'uxvheltris', 'naquadrium', 'cobalt'], 18480, va.uev, 1000, null, null)
AlienAlloy('caeldrox', 'ingot', 0x88AACC, 0x556644, METALLIC, [rod, frame, plates, gear, foil, no_abs_recipe], ['caelvr', 'fendrothex', 'titanium', 'tungsten'], 16940, va.uev, 800, null, null)
AlienAlloy('sturvik', 'ingot', 0x99AABB, 0x334455, METALLIC, [rod, frame, plates, gear, foil, no_abs_recipe], ['sturvaelix', 'drethnavik', 'darmstadtium', 'tantalum'], 18360, va.uev, 950, null, null)

AlienAlloy('morniloy-13', 'ingot', 0xB8A86A, 0x553322, SHINY, [rod, frame, plates, gear, foil, fine_wire, no_abs_recipe], ['2x caeldrox', '2x vrethren', '2x aelczyr', '6x mornivecht', 'antifermium'], 19440, va.uev, 1200, null, [v.uev, 32, 0, true])
AlienAlloy('sturvene-7', 'ingot', 0x65727C, 0x39444D, METALLIC, [plates, rod, gear, small_gear, frame, spring, bolt_and_screw, rotor, dense_plate, fine_wire, round, chainlet, chain_mesh, no_abs_recipe], ['2x sturvik', '2x jolvelix', '2x thulvaex', '6x sturvaelix', 'fermium'], 19400, va.uev, 1100, null, null)
...
event.create("omnium")
    ...
    .blastTemp(12000, null, va.uev, 800)
...
event.create('polydimensionalized_omnic_nexite')
    ...
    .iconSet(GTMaterialIconSet.getByName("omnium"))
    .blastTemp(19449, null, va.uev, 1600)
