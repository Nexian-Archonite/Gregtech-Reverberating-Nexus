...
event
    .create('gtceu:wizarding_steel_casing', "gtceu:active")
    .displayName('§bWizard §dSteel Casing')
    .textureAll('gtceu:block/casings/solid/wizarding_steel_casing')
    .model('gtceu:block/wizarding_steel_casing')
    .soundType('metal')
    .hardness(9)
    .resistance(23)
    .requiresTool(true)
