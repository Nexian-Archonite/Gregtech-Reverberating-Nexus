...
event.create("infinity")
    ...
    .components('1x nitrogen', '4x hydrogen', '1x rhenium', '4x oxygen')
    .formula('NH4ReO4')
    .color(0xd4d4d4).iconSet(SHINY)
    .dust()
    .flags(no_decomp)

event.create('rhenium_dioxide')
    .components('1x rhenium', '2x oxygen')
    .formula('ReO2')
    .color(0x3d3d3d).iconSet(DULL)
    .dust()
    .flags(no_decomp)
